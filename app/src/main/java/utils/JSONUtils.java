...
public class JSONUtils {
    ...
    public static final String SMALL_POSTER_SIZE = "w780"; // 185
    public static final String BIG_POSTER_SIZE = "w342";
    ...
    public static ArrayList<Trailer> getTrailersFromJSON(JSONObject jsonObject){
        ...
        try {
            ...
            for (int i =0; i< jsonArray.length(); i ++){
                ...
                String name = jsonObjectTrailers.getString(KEY_OF_NAME);
    ...
    public static ArrayList<Movie> getMoviesFromJSON(JSONObject jsonObject) {
        ...
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                Movie movie = new Movie(id, voteCount, originalTitle, title, overview, posterPath, bigPosterPath, backdropPath, voteAverage, releaseDate);
                result.add(movie);
            }
        } catch (JSONException e) {
            e.printStackTrace();
